...
#+EXPORT_FILE_NAME: ../docs/cloud_mount.html
...
* Code
  ...
  #+begin_src sh :tangle ../bin/cloud_mount.sh :exports none :tangle-mode (identity #o755)
    #!/usr/bin/env sh
...
** Check availability
   #+begin_src sh :tangle ../bin/cloud_mount.sh
     affirm_availability () {
