...
* Logouts
** bash
#+begin_src bash :tangle ../dotfiles/dot-bash_logout :noweb-ref logoutref
...
** common
*** Call files from all *.d directories
#+begin_src bash :tangle ../dotfiles/dot-logout
  _rc_drop_in "${HOME}/.logout"
#+end_src
