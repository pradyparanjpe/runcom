...
For automated setup, run the [dependencies script](./setup/dependencies.sh) with elevated privileges.
...
-   Affirm [requirements](#org790acbf).
...
<div class="warning" id="orgc8fd07e">
<p>
