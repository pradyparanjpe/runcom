...
#+TITLE: Use Emacs for Git Ediff
#+SETUPFILE: header.org
#+PROPERTY: header-args :tangle ../bin/ediff :mkdirp t :results no :eval no

* Description
Use Emacs' ediff tool as described [[https://github.com/paulotome/emacstool.git][here]].
Following wrapper shell script is adapted as directed and modified to be POSIX compliant.
