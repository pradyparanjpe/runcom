...
#+EXPORT_FILE_NAME: docs/proxy_send.html
...
* Code
  ...
  #+begin_src sh :tangle bin/proxy_send.sh :exports none :tangle-mode (identity #o755)
    #!/usr/bin/env sh
...
** Check availability
   #+begin_src sh :tangle bin/proxy_send.sh
     affirm_availability () {
...
** Extract proxy information from password-store
   #+begin_src sh :tangle bin/proxy_send.sh
     extract_key () {
